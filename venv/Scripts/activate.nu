...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\user\PycharmProjects\yandex_api_stand_tests\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\user\PycharmProjects\yandex_api_stand_tests\venv\Scripts\deactivate.nu'
